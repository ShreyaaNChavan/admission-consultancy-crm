            ...
            <div class="grid grid-cols-1 gap-6 p-8 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="Pending"
                        readonly
                        class="w-full rounded-xl border border-yellow-200 bg-yellow-50 px-4 py-3 font-semibold text-yellow-700">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-100">{{ old('reason') }}</textarea>
