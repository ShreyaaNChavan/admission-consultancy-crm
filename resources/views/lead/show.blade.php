...
@section('content')
    ...
    @if(
        ...
        <div class="bg-white shadow rounded p-6 mt-6">
            ...
            <form action="{{ route('leads.assign', $lead) }}" method="POST">
                ...
                <button class="mt-5 bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">
                    Assign Counselor
                </button>
    ...
    @if(
        ...
        <form action="{{ route('admissions.convert', $lead) }}" method="POST" class="my-6">
            ...
            <form action="{{ route('followups.store', $lead) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="remarks" rows="4" class="border w-full p-2 rounded"></textarea>
                ...
                <button class="mt-5 bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700">
                    Save Follow-up
                </button>
